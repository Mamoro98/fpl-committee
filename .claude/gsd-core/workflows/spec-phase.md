...
ones). Reference: @C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/Ammar/Dev/fpl-committee/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/Ammar/Dev/fpl-committee/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/templates/spec.md.
