...
```
Agent(
  prompt="Read C:/Users/Ammar/Dev/fpl-committee/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/templates/VALIDATION.md`
