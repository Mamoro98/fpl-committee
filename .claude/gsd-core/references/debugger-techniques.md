...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/Ammar/Dev/fpl-committee/.claude
                  → checks C:/Users/Ammar/Dev/fpl-committee/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core
                  → writes to C:/Users/Ammar/Dev/fpl-committee/.claude/gsd-core/hooks/
